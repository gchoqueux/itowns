...
export function getMaxColorLayerCount() {
    const { sizeColor_01, sizeColor_02 } = getCountColorLayer();
    return sizeColor_01 + sizeColor_02;
}
...
const LayeredMaterial = function LayeredMaterial(options) {
    ...
    this.fragmentShaderHeader += `const int TEX_UNITS = ${arrayColorLength.toString()};\n`;
    this.fragmentShaderHeader += `const int MAXCOUNTLAYER = ${maxColorLayerCount.toString()};\n`;
